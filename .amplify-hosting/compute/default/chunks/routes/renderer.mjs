...
import { k as eventHandler, l as setResponseHeader, m as send, n as getResponseStatus, o as setResponseStatus, q as setResponseHeaders, u as useNitroApp, r as joinRelativeURL, v as useRuntimeConfig, x as getQuery, c as createError, y as getRouteRules, z as getResponseStatusText } from '../../index.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Everything About Nuxt"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"title":"My Nuxt App"};
...
export { baseURL as a, buildAssetsURL as b, renderer$1 as r };
