import { version as version$1, unref, inject as inject$1, defineComponent as defineComponent$1, ref, provide, createElementBlock, watch, onScopeDispose, reactive, computed, watchEffect, toRefs, shallowRef, readonly, warn, getCurrentInstance as getCurrentInstance$1, toRaw, createVNode, mergeProps, h, shallowReactive, Suspense, nextTick, Transition, isRef, Fragment, toRef, Text, resolveDynamicComponent, withDirectives, resolveDirective, hasInjectionContext, effectScope, capitalize, useSSRContext, onUpdated, TransitionGroup, vShow, createApp, onErrorCaptured, onServerPrefetch, isReactive, getCurrentScope, isReadonly, withCtx, markRaw, isShallow } from 'vue';
import { $ as $fetch, c as createError$1, d as defu, a as createHooks, i as isSamePath, w as withQuery, b as hasProtocol, p as parseURL, e as isScriptProtocol, j as joinURL, t as toRouteMatcher, f as createRouter$1, g as getRequestHeaders, s as sanitizeStatusCode } from '../../index.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-CmMxi7hB.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./index-DMdYYdMx.mjs').then((m) => m.default || m)
  },
  {
    name: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.name) ?? "todo",
    path: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.path) ?? "/todo",
    meta: __nuxt_page_meta || {},
    alias: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.alias) || [],
    redirect: __nuxt_page_meta == null ? void 0 : __nuxt_page_meta.redirect,
    component: () => import('./index-D9TeGPnP.mjs').then((m) => m.default || m)
  }
];
...
const TOKEN_KEY = "sg-client-token";
const USER_DETAILS = "sg-user-details";
const loggedin = localStorage.getItem(TOKEN_KEY) ? true : false;
const user = localStorage.getItem(USER_DETAILS) ? JSON.parse(localStorage.getItem(USER_DETAILS)) : null;
...
const plugin_J8PkxsSQmi = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const layouts = {
  default: () => import('./default-O_pJ_1jy.mjs').then((m) => m.default || m),
  empty: () => import('./empty-B7VcNKFk.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[--><div><p>${ssrInterpolate(__props.error.statusCode)}</p><p>${ssrInterpolate(__props.error.message)}</p><button>Go Home ...</button></div>`);
      _push(ssrRenderComponent(VEmptyState, {
        headline: __props.error.statusCode,
...
export { pick as $, useVariant as A, useDensity as B, useDimension as C, useElevation as D, useLoader as E, useLocation as F, usePosition as G, useRounded as H, IconValue as I, useLink as J, VImg as K, LoaderSlot as L, genOverlays as M, makeTransitionProps as N, MaybeTransition as O, EventProp as P, useLocale as Q, Ripple as R, getCurrentInstanceName as S, useProxiedModel as T, useRtl as U, VBtn as V, getUid as W, useBackgroundColor as X, useTextColor as Y, convertToUnit as Z, isOn as _, useStore as a, wrapInArray as a0, getCurrentInstance as a1, useToggleScope as a2, only as a3, Intersect as a4, filterInputAttrs as a5, callEvent as a6, makeSizeProps as a7, useSize as a8, clamp as a9, isClickInsideElement as aA, focusableChildren as aB, getNextElement as aC, makeDisplayProps as aD, useDisplay as aE, toPhysical as aF, useResizeObserver as aG, eagerComputed as aH, findChildrenWithProvide as aI, _export_sfc as aJ, TOKEN_KEY as aa, VProgressCircular as ab, eventName as ac, destructComputed as ad, parseAnchor as ae, flipSide as af, flipAlign as ag, flipCorner as ah, consoleError as ai, getAxis as aj, defer as ak, templateRef as al, IN_BROWSER as am, matchesSelector as an, useRouter as ao, asyncDataDefaults as ap, createError as aq, fetchDefaults as ar, useRequestFetch as as, makeVBtnProps as at, defineComponent as au, deprecate as av, deepEqual as aw, focusChild as ax, getPropertyFromItem as ay, omit as az, useRuntimeConfig as b, useRender as c, propsFactory as d, entry$1 as default, makeTagProps as e, makeDensityProps as f, genericComponent as g, VIcon as h, injectHead as i, VDefaultsProvider as j, makeBorderProps as k, makeDimensionProps as l, makeComponentProps as m, makeElevationProps as n, makeLoaderProps as o, provideDefaults as p, makeLocationProps as q, resolveUnrefHeadInput as r, makePositionProps as s, makeRoundedProps as t, useNuxtApp as u, makeRouterProps as v, makeThemeProps as w, makeVariantProps as x, provideTheme as y, useBorder as z };
