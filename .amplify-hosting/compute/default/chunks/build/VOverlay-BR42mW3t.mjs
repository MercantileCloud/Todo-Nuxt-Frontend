import { createVNode, Transition, mergeProps, reactive, computed, toRef, watch, ref, Fragment, Teleport, withDirectives, vShow, resolveDirective, inject, watchEffect, nextTick, effectScope, onScopeDispose, shallowRef, provide, toRaw, readonly, warn } from 'vue';
import { b as animate, g as deceleratedEasing, s as standardEasing, h as acceleratedEasing, i as getTargetBox, n as nullifyTransforms, B as Box, j as getOverflow } from './forwardRefs-CbdZEUR7.mjs';
import { g as genericComponent, d as propsFactory, a1 as getCurrentInstance, m as makeComponentProps, l as makeDimensionProps, w as makeThemeProps, N as makeTransitionProps, T as useProxiedModel, y as provideTheme, U as useRtl, X as useBackgroundColor, C as useDimension, ao as useRouter, a2 as useToggleScope, c as useRender, Z as convertToUnit, O as MaybeTransition, al as templateRef, am as IN_BROWSER, _ as isOn, ac as eventName, ad as destructComputed, ae as parseAnchor, af as flipSide, ag as flipAlign, ah as flipCorner, an as matchesSelector, ai as consoleError, aj as getAxis, a9 as clamp, ak as defer } from './server.mjs';
...
export { VDialogTransition as V, VOverlay as a, VMenuSymbol as b, makeDelayProps as c, useDelay as d, makeVOverlayProps as m, useScopeId as u };
//# sourceMappingURL=VOverlay-BR42mW3t.mjs.map
